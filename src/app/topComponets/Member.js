      ...
      <div className="hidden md:block">
        ...
        >
          ...
          <div className="w-[370] h-[480]  bg-blue-950 bg-bg bg-contain p-8 text-center text-white">
            ...
            <p className="text-base h-16">カリフォルニア大学バークレー校学部4年生。宇宙物理学専攻、障害者学副専攻。</p>
            </div>
          </SplideSlide>
          <SplideSlide>
          <div className="w-[370] h-[480]  bg-blue-950 bg-bg bg-contain p-8 text-center text-white">
            ...
            <p className="text-base h-16">カリフォルニア大学バークレー校卒。生物学専攻、データサイエンス副専攻</p>
            </div>
          </SplideSlide>
          <SplideSlide>
          <div className=" bg-blue-950 bg-bg bg-contain p-8 text-center text-white">
            ...
            <p className="text-base h-16">カリフォルニア大学バークレー校卒。宇宙物理学専攻。</p>
            </div>
          </SplideSlide>
        </Splide>
      </div>
      <div className="md:hidden block">
        ...
        >
          <SplideSlide>
            ...
            <p className="text-[8px] h-10">カリフォルニア大学バークレー校学部4年生。宇宙物理学専攻、障害者学副専攻。</p>
            </div>
          </SplideSlide>
          <SplideSlide>
            <div className="w-[370] h-[480] bg-blue-950 bg-bg bg-contain p-3 text-center text-white">
            ...
            <p className="text-[8px] h-10">カリフォルニア大学バークレー校卒。生物学専攻、データサイエンス副専攻</p>
            </div>
          </SplideSlide>
          <SplideSlide>
            <div className="w-[370] h-[480] bg-blue-950 bg-bg bg-contain p-3 text-center text-white">
            ...
            <p className="text-[8px] h-10">カリフォルニア大学バークレー校卒。宇宙物理学専攻。</p>
            </div>
          </SplideSlide>
